...
public class AutoResizeTextView extends TextView {
    ...
    private final SizeTester mSizeTester = new SizeTester() {
        ...
        public int onTestSize(int suggestedSize, RectF availableSPace) {
            ...
            if (singleline) {
                ...
                StaticLayout layout =
                        new StaticLayout(text, mPaint, mWidthLimit, Alignment.ALIGN_NORMAL,
    ...
    private void adjustTextSize(String string) {
        ...
        super.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                efficientTextSizeSearch(startSize, (int) mMaxTextSize, mSizeTester,
                        mAvailableSpaceRect));
    }
    ...
    private int efficientTextSizeSearch(int start, int end, SizeTester sizeTester,
            RectF availableSpace) {
        if (!mEnableSizeCache) {
